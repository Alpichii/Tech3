package codingBats;
    ...
    public class WarmUp2 {
        ...
        public boolean parrotTrouble(boolean talking, int hour) {
            if(!(7 <= hour && hour <= 20) && talking) return true;
            return false;
        }
        //6
        ...
        public boolean loneTeen(int a, int b) {
            if((a > 12 && a < 20) && !(b > 12 && b < 20) || !(a > 12 && a < 20) && (b > 12 && b < 20)) return true;
            return false;
        }
        //21
        public String delDel(String str) {
            if(str.length() > 3 && str.substring(1, 4).equalsIgnoreCase("del")) return str.substring(0,1) + str.substring(4);
            return str;
        }
        //22
        public boolean mixStart(String str) {
            if(str.length() > 2 && str.substring(1,3).equalsIgnoreCase("ix")) return true;
            return false;
        }
        //23
        public String startOz(String str) {
            if(str.length() == 0) return "";
        else if(str.length() == 1 && str.equalsIgnoreCase("o")) return str;
            else{
                String s = "";
