...
//23
        public String conCat(String a, String b) {
            if(!a.isEmpty() && !b.isEmpty()) {
                if(a.endsWith("" + b.charAt(0))) return a + b.substring(1);
            }
            return a+b;
        }
...
//24
        public String lastTwo(String str) {
            ...
            if(str.length() == 1) return str;
                ...
                newStr = str.substring(0, str.length()-2) + str.charAt(str.length()-1) + str.charAt(str.length()-2);
            }
            return newStr;
        }
...
//30
        public String deFront(String str) {
            if(!str.isEmpty()){
                if(str.length() == 1 && str.equals("a")) return str;
                else if(str.length() >=2){
                    String newStr = "";
